...
- **Last updated:** 2026-09-04 00:24:39 UTC
- **Nextflow version:** 26.08.0-edge

## Pipelines

- **Total:** 0 parse errors, 1238 errors, 6119 warnings across 143 pipelines
...
| :x: [rnasplice](https://github.com/nf-core/rnasplice)                                          |     No      |     14 |       19 |      -      |         [View](lint_results/pipeline-results/rnasplice_lint.md)         |                                    -                                     |
...
| :x: [oncoanalyser](https://github.com/nf-core/oncoanalyser)                                    |     No      |      0 |      106 |     No      |       [View](lint_results/pipeline-results/oncoanalyser_lint.md)        |      [View](lint_results/prints-help-results/oncoanalyser_help.txt)      |
...
| :white_check_mark: [taxprofiler](https://github.com/nf-core/taxprofiler)                       |     No      |      0 |       54 |     Yes     |        [View](lint_results/pipeline-results/taxprofiler_lint.md)        |      [View](lint_results/prints-help-results/taxprofiler_help.txt)       |
...
| :x: [genomeassembler](https://github.com/nf-core/genomeassembler)                              |     No      |      0 |        7 |     No      |      [View](lint_results/pipeline-results/genomeassembler_lint.md)      |    [View](lint_results/prints-help-results/genomeassembler_help.txt)     |
...
| :x: [proteinannotator](https://github.com/nf-core/proteinannotator)                            |     No      |      0 |        0 |     No      |     [View](lint_results/pipeline-results/proteinannotator_lint.md)      |    [View](lint_results/prints-help-results/proteinannotator_help.txt)    |
...
| :x: [phyloplace](https://github.com/nf-core/phyloplace)                               |     No      |   Yes (5)    |        [View](lint_results/workflow-outputs-results/phyloplace_outputs.md)         |
...
- **Total:** 0 parse errors, 0 errors, 25 warnings across 2055 modules
- **Zero errors:** 2055 modules (100.0%)
...
_Modules with zero errors are not shown above (2055 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._

</details>

## Subworkflows

- **Total:** 0 parse errors, 0 errors, 7 warnings across 122 subworkflows
- **Zero errors:** 122 subworkflows (100.0%)
...
_Subworkflows with zero errors are not shown above (122 subworkflows). They may still have warnings. See the [subworkflows results directory](lint_results/subworkflow-results/) for all lint outputs._
